...
## 🛠️ Stack Técnico
* **Backend:** Django 5.x
* **Base de Datos:** SQL (Compatible con PostgreSQL/MySQL/SQLite)
* **Seguridad:** Implementación de ORM para mitigación de SQL Injection y protección CSRF nativa.

## 🔍 Conceptos Aplicados
* **Abstracción de Base de Datos:** Uso de Modelos para definir esquemas relacionales.
* **Integridad de Datos:** Validaciones a nivel de modelo para asegurar logs consistentes.
